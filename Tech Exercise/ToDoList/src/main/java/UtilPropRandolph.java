...
public class UtilPropRandolph {
   static final boolean _W = System.getProperty("os.name").toLowerCase().contains("windows");
   static String _PROP_FILENAME_WIN_LOCAL = null;
   static String _PROP_FILENAME_OSX_LOCAL = "/Users/zach/workspace_CSCI4830_Randolph/Tech Exercise/ToDoList/src/main/webapp/config.properties";
   static String _PROP_FILENAME_REMOTE = "/var/lib/tomcat7/webapps/ToDoList/config.properties";
